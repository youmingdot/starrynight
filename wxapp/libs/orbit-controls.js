...
THREE.OrbitControls = function ( object, sn ) {
    ...
    function handleTouchStartDollyPan( event ) {
        ...
        if ( scope.enablePan ) {
            ...
            var x = 0.5 * ( event.pointers[ 0 ].pageX + event.pointers[ 1 ].pageX );
            var y = 0.5 * ( event.pointers[ 0 ].pageY + event.pointers[ 1 ].pageY );
    ...
    function handleTouchMoveRotate( event ) {
        ...
        rotateLeft( 2 * Math.PI * rotateDelta.x / scope.sn.height ); // yes, height

        rotateUp( 2 * Math.PI * rotateDelta.y / scope.sn.height );
